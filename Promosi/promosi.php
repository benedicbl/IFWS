...
// 1. Webinar Pending Poster (Belum Selesai & Poster Kosong)
// Ini adalah tugas utama tim promosi
...
// 2. Webinar Poster Ready (Belum Selesai & Poster Ada)
...
<head>
    ...
    <style>
        ...
        .shortcuts-grid { display: grid; grid-template-columns: repeat(1, 1fr); gap: 15px; } /* 1 Kolom karena menu promosi sedikit */
        .shortcut-btn {
            background: white; padding: 20px; border-radius: 10px; text-align: center; text-decoration: none; color: #4b5563; border: 1px solid #e5e7eb; transition: all 0.3s; display: flex; flex-direction: row; justify-content: center; align-items: center; gap: 15px;
        }
        .shortcut-btn i { font-size: 24px; color: #2563eb; }
        .shortcut-btn span { font-size: 16px; font-weight: 500; }
    ...
    <div class="container">
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="admin-profile"><small>Promosi</small></div>
            </div>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-container">
                ...
                <div class="profile-widget">
                    <div class="profile-img-circle"><i class="fas fa-bullhorn"></i></div>
                    <div class="profile-name"><?= htmlspecialchars($user['nama_lengkap']) ?></div>
                    <div class="profile-role">Tim Promosi</div>
                ...
                <div class="right-content">
                    ...
                    <div class="task-card">
                        <div class="task-info">
                            <h3><i class="fas fa-image"></i> Poster Belum Ada</h3>
                            <p>Terdapat <strong><?= $d_pending['total'] ?> Webinar</strong> yang belum memiliki Poster.</p>
                        </div>
                        <a href="promosi_datawebinar.php" class="btn-task-action">Upload Poster <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <?php else: ?>
                    <div class="task-card" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); box-shadow: 0 4px 10px rgba(16, 185, 129, 0.3);">
                        <div class="task-info">
                            ...
                            <p>Semua webinar mendatang sudah memiliki Poster.</p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            <div class="stat-icon icon-red"><i class="fas fa-file-image"></i></div>
                            <div class="stat-info">
                    ...
                    <div class="shortcuts-section">
                        ...
                        <div class="shortcuts-grid">
                            <a href="promosi_datawebinar.php" class="shortcut-btn">
                                <i class="fas fa-cloud-upload-alt"></i>
                                <span>Kelola Poster Webinar</span>
                            </a>
                        </div>
                    </div>
