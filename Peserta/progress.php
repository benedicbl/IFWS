...
$min_ifws_ta = (int)(mysqli_fetch_assoc($result_settings)['setting_value'] ?? 3);

// 3. Hitung jumlah kehadiran VALID
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <h1>Progress Prasyarat Sidang Tugas Akhir</h1>
                ...
                <div class="progress-card">
                    <div class="progress-card-header">
                        <h2 style="display: flex; align-items: center;">
                            Tipe Tugas Akhir :
                            <span class="ta-badge <?= ($status_ta == 'TA_1') ? 'ta-1' : 'ta-2' ?>">
                                <?= str_replace('_', ' ', $status_ta) ?>
                            </span>
                        </h2>
