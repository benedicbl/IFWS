                ...
                <form method="GET" action="" class="filter-left">
                    ...
                    <select name="filter_periode" id="filter_periode" class="filter-select" onchange="this.form.submit()">
                        ...
                        <?php foreach ($available_years as $yr): ?>
                            <option value="Ganjil-<?= $yr ?>" <?= ($filter_periode == "Ganjil-$yr") ? 'selected' : '' ?>>Ganjil - <?= $yr ?> (Jul - Des)</option>
                            <option value="Genap-<?= $yr ?>" <?= ($filter_periode == "Genap-$yr") ? 'selected' : '' ?>>Genap - <?= $yr ?> (Jan - Jun)</option>
                        <?php endforeach; ?>
                    </select>
