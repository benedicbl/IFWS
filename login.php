...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand-text {
            display: flex; flex-direction: column; line-height: 1.2; color: #1e3a8a;
        }
        ...
        .input-group input {
            width: 100%; padding: 12px 12px 12px 40px; border: 1px solid #d1d5db; border-radius: 8px; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif; transition: border-color 0.3s;
        }
        ...
        .input-group i.icon-toggle { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #9ca3af; cursor: pointer; }
        ...
        .right-panel { width: 50%; background: linear-gradient(135deg, #1e3a8a 0%, #2563eb 100%); }
        ...
        /* Fix Icon Mata Ganda di Edge/Chrome */
        ...
        <div class="left-panel">
            ...
            <form action="proses_login.php" method="POST">
                ...
                <div class="options">
                    ...
                    <a href="lupa_password.php" class="forgot-pass">Lupa Password?</a>
                </div>
