document.addEventListener('DOMContentLoaded', () => {
    ...
    const inputDurasi = document.getElementById('durasi-menit');
    ...
    confirmSaveBtn.addEventListener('click', () => {
        const durasiInput = document.getElementById('durasi-menit');
        const nilaiDurasi = inputDurasi.value;

        // Kirim data ke API
        fetch('/proyek-ifws/api/peraturan_handler.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ peraturan_waktu: nilaiDurasi })
        })
