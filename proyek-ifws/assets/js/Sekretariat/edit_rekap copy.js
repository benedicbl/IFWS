document.addEventListener('DOMContentLoaded', () => {
    ...
    if (webinarId && webinarData[webinarId]) {
        ...
        document.getElementById('kembali-btn').href = `/proyek-ifws/pages/Sekretariat/lihat_rekap.php?id=${webinarId}`;
    ...
    document.getElementById('save-btn').addEventListener('click', () => {
        ...
        window.location.href = `/proyek-ifws/pages/Sekretariat/lihat_rekap.php?id=${webinarId}`;
    });
});