...
<head>
    <meta charset="UTF-8">
    <title>Lihat Rekap Peserta</title>
    ...
    <div class="app-layout">
        ...
        <main class="main-content">
            ...
            <div class="page-actions">
                <a href="list_ifws_sekretariat.php" class="btn btn-kembali">Kembali</a>
                <a id="edit-rekap-btn" href="#" class="btn btn-edit">Edit</a>
            </div>
        </main>
    </div>
    <script src="/proyek-ifws/assets/js/Sekretariat/lihat_rekap.js"></script>
</body>
</html>