...
<head>
    ...
    <title>Dashboard Sekretariat - IFWS</title>
...
<body>
    ...
    <div class="container">
        <header class="page-header">
            <div class="user-info">
                <p class="user-name">SEKRETARIAT IFWS</p>
                <p class="user-email">sekretariat@ifws.com</p>
            </div>
        ...
        <main class="main-section">
            ...
            <nav class="menu-navigation">
                <a href="list_ifws_sekretariat.php" class="menu-card">
                    <i class="fa-solid fa-list-ul"></i>
                    <span>List IFWS</span>
                </a>
                <a href="peserta_ta.php" class="menu-card">
                    <i class="fa-solid fa-chalkboard-user"></i>
                    <span>Peserta Tugas Akhir</span>
                </a>

                <a href="sertifikat.php" class="menu-card">
