...
<head>
    ...
    <link rel="stylesheet" href="/proyek-ifws/assets/css/PIC/tambah_webinar_style.css">
...
<body>
    <div class="app-layout">
        ...
        <main class="main-content">
                ...
                <div class="form-container">
                    <form id="webinar-form">
                        ...
                        <div class="form-group">
                            <label for="jenis-ifws">Jenis IFWS</label>
                            <select id="jenis-ifws" name="id_jenis_ifws" required>
                        ...
                        <div class="page-actions">
                            ...
                            <button type="submit" class="btn btn-simpan">Simpan & Lanjut Pilih Peserta</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div id="pilih-peserta-wrapper" class="hidden">
                <h1>Pilih Peserta untuk Webinar</h1>
                ...
                <div class="page-actions"><button id="save-peserta-btn" class="btn btn-simpan">Selesai & Simpan Webinar</button></div>
            </div>
        </main>
    </div>
    ...
    <script src="/proyek-ifws/assets/js/PIC/tambah_webinar_script.js"></script>
</body>
</html>