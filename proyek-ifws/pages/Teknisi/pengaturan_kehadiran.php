<?php include '../../includes/auth_check.php';
    ...
    $nilai_durasi = $peraturan['peraturan_waktu'] ?? 45; 
?>
...
<body>
    <div class="app-layout">
        ...
        <main class="main-content">
            <h1>Pengaturan Durasi Kehadiran</h1>
            <div class="settings-card">
                <form id="settings-form">
                    <div class="setting-item">
                        <label for="durasi-menit">Durasi minimal kehadiran agar terhitung valid</label>
                        <div class="input-wrapper">
                            <input type="number" id="durasi-menit" min="1" value="<?php echo htmlspecialchars($nilai_durasi); ?>">
                            <span>menit</span>
                        </div>
                    </div>
                </form>
    ...
    <script src="/proyek-ifws/assets/js/Teknisi/pengaturan_kehadiran_script.js"></script>
</body>
</html>