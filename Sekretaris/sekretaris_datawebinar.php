...
<html lang="en">
<head>
    <meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>Sekretaris - Data Webinar</title>
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <div class="page-header"><h1>Riwayat Data Webinar (Selesai)</h1></div>
            ...
            <form method="GET" action="" class="filter-container">
                ...
                <?php if(!empty($filter_periode)): ?><a href="sekretaris_datawebinar.php" class="btn-reset"><i class="fas fa-times"></i> Reset</a><?php endif; ?>
            </form>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/projek-ifws/Sekretaris/sekretaris_rekapperserta.php?id_webinar=<?= $webinar['id'] ?>" class="btn btn-primary">Rekap Kehadiran</a>
                            </td>
                        </tr>
                        <?php endwhile; else: ?>
