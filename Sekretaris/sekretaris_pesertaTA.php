...
<html lang="en">
<head>
    <meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>Peserta Tugas Akhir</title>
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section"><p class="section-title">KELOLA DATA IFWS</p><ul>
                    <li><a href="/projek-ifws/Sekretaris/sekretaris_datawebinar.php"><i class="fas fa-calendar-alt"></i><span>Data Webinar</span></a></li>
                    <li class="active"><a href="/projek-ifws/Sekretaris/sekretaris_pesertaTA.php"><i class="fas fa-user-friends"></i><span>Peserta Tugas Akhir</span></a></li>
                    <li><a href="/projek-ifws/Sekretaris/sekretaris_kelolasertif.php"><i class="fas fa-award"></i><span>Kelola Sertifikat</span></a></li>
                </ul></div>
        ...
        <main class="main-content">
            ...
            <div class="filter-bar">
                <form method="GET" action="" class="filter-left">
                    ...
                    <?php if(!empty($filter_periode)): ?><a href="sekretaris_pesertaTA.php" class="btn-reset"><i class="fas fa-times"></i> Reset</a><?php endif; ?>
                </form>
            ...
            <div class="overlay-body">
                <form action="/projek-ifws/api/import_peserta.php" method="POST" enctype="multipart/form-data">
                    <p style="font-size:13px; color:#666; margin-bottom:15px;">
                        ...
                        <em style="color:#d9534f;">*Jika NPM sudah ada, data akan diperbarui ke Tahun Akademik saat ini.</em>
                    </p>
