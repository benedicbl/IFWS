...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand-text { display: flex; flex-direction: column; line-height: 1.2; color: #2563eb; }
        ...
        .btn-login { width: 100%; padding: 12px; background-color: #2563eb; color: white; border: none; border-radius: 8px; font-weight: 500; cursor: pointer; font-size: 14px; transition: background 0.3s; font-family: 'Poppins', sans-serif; }
        ...
        .right-panel { width: 50%; background: linear-gradient(135deg, #2563eb 0%, #2e5a9e 100%); }
