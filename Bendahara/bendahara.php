...
// 1. Total Webinar Selesai (Target pembayaran)
...
// 2. Total Bukti Insentif Terupload (Yang sudah dibayar)
$q_upload = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM bukti_insentif");
$d_upload = mysqli_fetch_assoc($q_upload);

// 3. Hitung Pending (Selesai - Terupload)
// Menggunakan LEFT JOIN untuk mencari webinar finished yang ID-nya TIDAK ADA di tabel bukti_insentif
$q_pending = mysqli_query($koneksi, "
    SELECT COUNT(*) as total 
    FROM webinars w
    LEFT JOIN bukti_insentif b ON w.id = b.id_webinar
    WHERE w.status = 'finished' AND b.id IS NULL
");
$d_pending = mysqli_fetch_assoc($q_pending);

// 4. Total Narasumber Terdaftar
    ...
    <div class="container">
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="admin-profile"><small>Bendahara</small></div>
            </div>
            <nav class="sidebar-nav">
                <div class="nav-section"><p class="section-title">DASHBOARD</p><ul><li class="active"><a href="/projek-ifws/Bendahara/bendahara.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li></ul></div>
                <div class="nav-section"><p class="section-title">KELOLA DATA IFWS</p><ul><li><a href="/projek-ifws/Bendahara/bendahara_datanarsum.php"><i class="fas fa-user-friends"></i><span>Data Narasumber</span></a></li><li><a href="/projek-ifws/Bendahara/bendahara_buktitrf.php"><i class="fas fa-file-invoice-dollar"></i><span>Bukti Insentif</span></a></li></ul></div>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-container">
                ...
                <div class="profile-widget">
                    <div class="profile-img-circle"><i class="fas fa-wallet"></i></div>
                ...
                <div class="right-content">
                    ...
                    <div class="task-card">
                        <div class="task-info">
                            <h3><i class="fas fa-exclamation-triangle"></i> Perlu Tindakan</h3>
                            <p>Terdapat <strong><?= $d_pending['total'] ?> Webinar Selesai</strong> yang belum diupload bukti insentifnya.</p>
                        </div>
                        <a href="bendahara_datanarsum.php" class="btn-task-action">Upload Bukti <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <?php else: ?>
                    <div class="task-card" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); box-shadow: 0 4px 10px rgba(16, 185, 129, 0.3);">
                        <div class="task-info">
                            ...
                            <p>Semua webinar selesai sudah diberikan insentif.</p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                <h3><?= $d_upload['total'] ?></h3>
                                <p>Insentif Terupload</p>
                            </div>
                        </div>
                        <div class="stat-card">
                    ...
                    <div class="shortcuts-section">
                        ...
                        <div class="shortcuts-grid">
                            <a href="bendahara_datanarsum.php" class="shortcut-btn">
                                <i class="fas fa-hand-holding-usd"></i>
                                <span>Kelola Insentif</span>
                            </a>
                            <a href="bendahara_buktitrf.php" class="shortcut-btn">
